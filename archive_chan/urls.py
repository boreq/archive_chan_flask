...
urlpatterns = patterns('',
    ...
    # Board.
    url(r'^board/(?P<board>[a-z]+)/$', views.BoardView.as_view(), name='board'),
    url(r'^board/(?P<board>[a-z]+)/stats/$', views.StatsView.as_view(), name='board_stats'),
    url(r'^board/(?P<board>[a-z]+)/gallery/$', views.GalleryView.as_view(), name='board_gallery'),
    ...
    url(r'^board/(?P<board>[a-z]+)/thread/(?P<thread>[0-9]+)/stats/$', views.StatsView.as_view(), name='thread_stats'),
    url(r'^board/(?P<board>[a-z]+)/thread/(?P<thread>[0-9]+)/gallery/$', views.GalleryView.as_view(), name='thread_gallery'),
